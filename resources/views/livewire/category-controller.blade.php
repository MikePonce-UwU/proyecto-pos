                            ...
                            <table class="table table-sm table-bordered">
                                <thead class="table-secondary">
                                    <tr class="text-center">
                                        <th style="font:bold;">Categoría</th>
                                                ...
                                                <div class="btn-toolbar justify-content-center" role="toolbar">
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-sm btn-outline-secondary" type="button"
                                                            wire:click="showCategoryById({{ $categoria->id }})">
                                                        ...
                                                        @can('category-update')
                                                            <button type="button" class="btn btn-sm btn-outline-secondary"
                                                                wire:click="editCategoryById({{ $categoria->id }})">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                        ...
                                                        @can('category-destroy')
                                                            <button class="btn btn-sm btn-outline-secondary" type="button"
                                                                wire:click="deleteCategoryById({{ $categoria->id }})">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                {{-- <input id="description" type="text"
                                    ...
                                    value="{{ old('description') }}" required autofocus wire:model="description"> --}}
...
@push('scripts')
    <script>
        window.addEventListener('closeModal', event => {
            // document.getElementById('addNewCategory').hide();
            // document.getElementById('editCategory').hide();
            $('#viewCategory').modal('hide');
            $('#addNewCategory').modal('hide');
            $('#editCategory').modal('hide');
            $('#destroyCategory').modal('hide');
        });
        window.addEventListener('openEditModal', event => {
            $("#editCategory").modal('show');
        })
        window.addEventListener('DestroyCategoryModal', event => {
            $("#destroyCategory").modal('show');
        })

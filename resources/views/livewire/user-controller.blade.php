<div>
    ...
    <div wire:ignore.self class="modal fade" id="addNewUser" tabindex="-1" aria-labelledby="AddNewUser"
        aria-hidden="true">
    ...
    <div wire:ignore.self class="modal fade" id="editUser" tabindex="-1" aria-labelledby="EditUser"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div wire:ignore.self class="modal fade" id="viewUser" tabindex="-1" aria-labelledby="ViewUser"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div wire:ignore.self class="modal fade" id="destroyUser" tabindex="-1" aria-labelledby="DestroyUser"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
